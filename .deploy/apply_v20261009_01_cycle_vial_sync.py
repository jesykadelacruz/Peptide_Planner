...
replace_once(
    ...
    '      calculatedOpenDate,calculatedFinishDate:automaticFinishDate,openDate,finishDate,disposeDate,',
    'cycled calculated finish date'
)
...
print(f'Applied {VERSION}: cycled Full Dose canonicalization, Cycle Dose/Finish synchronization, and sequential vial Open dates')
